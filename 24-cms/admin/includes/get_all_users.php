                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($get_all_users)) {
                                    ...
                                    echo "<td><a onClick=\"javascript: return confirm('Confirm delete?')\" href='users.php?delete={$user_id}'>Delete</a></td>";
                                    echo "</tr>";
                                }     
...
if (isset($_GET['delete'])) {
    $deleted_id = mysqli_real_escape_string($connection, $_GET['delete']);
